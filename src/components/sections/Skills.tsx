        ...
        <div className="grid gap-6 md:grid-cols-3 md:gap-8">
          {skills.map(({ category, items, color }) => {
            ...
            return (
              <div
                key={category}
                className="rounded-lg border-2 border-foreground bg-white p-6 shadow-soft transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1"
              >
                <div
