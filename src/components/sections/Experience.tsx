      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mx-auto max-w-2xl space-y-6">
          {experiences.map(({ role, company, period, description }, i) => (
            <div
              key={i}
              className="relative rounded-lg border-2 border-foreground bg-white p-6 shadow-soft transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1"
            >
              {/* Floating icon */}
